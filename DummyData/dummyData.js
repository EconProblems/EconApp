...
const supplyQuestions3 = {
  ...
  questions: [
    ...
    {
      question: 'If there is a sudden surge in demand for bread in town due to a population increase, what will happen to the supply of bread if there are some bakeries currently "shuttered" and not operating',
      pos: 'right'
    },
    {
