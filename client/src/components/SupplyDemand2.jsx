...
import { supplyDemandQuestions2 } from "../../../DummyData/supplyDemandDummyData.js";
...
export default function SupplyDemand2(props) {
  const percent = 100 / supplyDemandQuestions2.questions.length;
  const [questions, setQuestions] = useState(supplyDemandQuestions2.questions);
  ...
  const incorrectSetNextQuestion = () => {
    ...
    setQuestions(prevQuestions => {
      const newQuestions = [...prevQuestions];
      const randomIndex = Math.floor(Math.random() * supplyDemandQuestions2.questions.length);
      newQuestions.push(supplyDemandQuestions2.questions[randomIndex]);
      return newQuestions;
    });
